...
public class CustomerActivity extends Activity {
   ...
   private void setMemberView() {
      ...
      customerData = getIntent().getStringArrayListExtra("customers");
            ...
            .setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
               ...
               public boolean onItemLongClick(AdapterView<?> parentView,
                  ...
                  if (customerData.size() != 1) {
                     ...
                     builder.setMessage(R.string.delete_last_customer)
                           .setTitle(R.string.delete_last_customer_title);
   ...
   public void addCustomer(String name) {
      ...
      runOnUiThread(new Runnable() {
         @Override
         public void run() {
            CustomerArrayAdapter adapter = new CustomerArrayAdapter(
                  CustomerActivity.this, R.layout.customer_list, customerData);
            customerListView.setAdapter(adapter);
         }
      });
   }
