...
public class MainActivity extends Activity implements HttpResultCallable {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int[] res = { R.drawable.botteroski, R.drawable.bpn,
				R.drawable.chalet1400, R.drawable.delmonte,
	 ...
	 *            LOGIN: if result[0] = "Incorrect", credentials are not
	 *            correct, else it has no meaning
	 * @param _features
				...
				public void run() {
					try {
						...
						helper.openGenericConnection(Request.SNOW,
								MainActivity.this, new URL(WEATHER2_API));
					} catch (Exception e) {
						e.printStackTrace();
					}
				}
